create sequence hibernate_sequence start with 1 increment by 1
    ...
    alter table customers 
       add constraint UK_2nn30ukoh3qlhdyigtupb6ivb unique (user_name)
    ...
    alter table shipping_info 
       add constraint FKa9y078xf8pipd874t8dftsrry 
       foreign key (location_id) 
       references location

    alter table shipping_info 
       add constraint FK45idk6acnnfditxgyyk613m6r 
       foreign key (order_id) 
       references orders

    alter table shipping_info 
       add constraint FKbq6dqx4gq3t6tty5y1a6pnalv 
       foreign key (product_id) 
       references product

    alter table stock 
       add constraint FK6t3m0kaf6fubuus331gf7xmn8 
       foreign key (location_id) 
       references location
